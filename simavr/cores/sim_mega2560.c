...
const struct mcu_t {
	...
	.uart2 = {
		...
		AVR_UART_RX_INTERRUPT_DECLARE(2),
		AVR_UART_TX_INTERRUPT_DECLARE(2),
		AVR_UART_UDR_INTERRUPT_DECLARE(2),
	},
	...
	.uart3 = {
		...
		AVR_UART_RX_INTERRUPT_DECLARE(3),
		AVR_UART_TX_INTERRUPT_DECLARE(3),
		AVR_UART_UDR_INTERRUPT_DECLARE(3),
	},
	.adc = {
		.r_admux = ADMUX,
